 ...
 * @author raffy
 */
public class EncryptorDecryptorMgr {

    private Cipher encryptCipher;
    private Cipher decryptCipher;
    private sun.misc.BASE64Encoder encoder = new sun.misc.BASE64Encoder();
    private sun.misc.BASE64Decoder decoder = new sun.misc.BASE64Decoder();
    private static EncryptorDecryptorMgr instance;

    public static EncryptorDecryptorMgr getInstance() {
        if (instance == null) {
            instance = new EncryptorDecryptorMgr();
        }
        return instance;
    }

    public EncryptorDecryptorMgr() throws SecurityException {
        java.security.Security.addProvider(new com.sun.crypto.provider.SunJCE());

        char[] pass = "CREATING Q SOFTWARE T IS A FUN X STUFF L TO DO".toCharArray();
