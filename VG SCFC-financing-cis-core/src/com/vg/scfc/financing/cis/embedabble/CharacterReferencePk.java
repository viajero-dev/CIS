 ...
 */
@Embeddable
public class CharacterReferencePk implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final CharacterReferencePk other = (CharacterReferencePk) obj;
    ...
    public int hashCode() {
        int hash = 7;
        hash = 59 * hash + Objects.hashCode(this.txFormNo);
