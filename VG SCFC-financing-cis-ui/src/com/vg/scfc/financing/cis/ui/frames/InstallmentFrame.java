 ...
 * @author rodel
 */
public class InstallmentFrame extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InstallmentFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
