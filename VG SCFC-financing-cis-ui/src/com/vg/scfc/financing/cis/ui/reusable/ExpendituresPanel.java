...
public class ExpendituresPanel extends javax.swing.JPanel implements KeyListener {
    ...
    public final void policySetting() {
        UISetting.policy.addIndexedComponent(txtMonthlyDeduction);
        UISetting.policy.addIndexedComponent(txtMonthlyHouseholdBill);
        UISetting.policy.addIndexedComponent(txtAmortization);
        UISetting.policy.addIndexedComponent(txtMaintenanceDesc);
        UISetting.policy.addIndexedComponent(txtMaintenance);
        UISetting.policy.addIndexedComponent(txtLivingAllowance);
        UISetting.policy.addIndexedComponent(txtEducationDesc);
        UISetting.policy.addIndexedComponent(txtEducation);
        UISetting.policy.addIndexedComponent(txtOthers);
    }
